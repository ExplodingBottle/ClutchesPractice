...
public class LoadedConfiguration {
	...
	public boolean cancelWeatherChanges;
	public double failedHeight;
	public int deletionDelayTicks;
	public int firstKnockbackDelayTicks;
	public double knockbackForce;
	public double jumpForce;
	public Material clutchBlockType;
	public int clutchBlocksAmount;
